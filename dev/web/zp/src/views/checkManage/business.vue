 ...
 * @Last Modified time: 2019-12-28 09:03:18
 */
<template>
  <div id="businessCheck">
    <div class="searchDiv">
      <el-select @change="provinceChange" size="mini" v-model="province" clearable placeholder="全部">
        <el-option
    ...
    <div class="tableDiv">
      ...
      >
        ...
        <el-table-column align="center" label="操作" width="100">
          <template slot-scope="scope">
            <el-button type="text" @click="toEdit(scope.row)" size="small">通过</el-button>
            <el-button type="text" size="small" @click="toDelete(scope.row.id)">拒绝</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <div class="footerDiv">
      <div class="btnDiv">
        <el-button @click="toBatchDelete" size="mini" type="danger" plain>一键通过</el-button>
      </div>
      <div class="pageDiv">
        <el-pagination
          :page-size="pageSize"
